    ...
    public static class DEEP_STORAGE_STRINGS
    {
        public static class BUILDINGS
        {
            public static class PREFABS
            {
                ...
                {
                    public static LocString NAME = "Deep Storage Unit";

                    // This one goes on the bottom
                    public static LocString DESC = "Just as before, they asked \"What if we could go smaller?\", ignoring the laws of physics.\n\n" +
                    ...
                    public static LocString EFFECT = "Stores an infinite amount of any solid resources.";
                }
            }
        }
        ...
        public static class UI
        {
            public static class SHOWHIDE_CONTENTS
            {
                ...
                public static LocString HIDE_TOOLTIP = $"Hide the contents of the {BUILDINGS.PREFABS.ASQUARED31415_INFINITEITEMSTORAGE.NAME}.";
            }
        }
    }
}