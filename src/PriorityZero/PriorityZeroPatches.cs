...
namespace PriorityZero
{
    ...
    public static class Util
    {
        ...
        public static readonly string
            ModPath = Directory.GetParent( Assembly.GetExecutingAssembly().Location ).FullName;
    }
    ...
    public class MinionTodoChoreEntry_Apply_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler( IEnumerable<CodeInstruction> origCode )
        {
            ...
            if ( !patched )
                Debug.LogWarning( "[PriorityZero] Unable to find TodoChoreEntry offset." );
        }
    }
    ...
    public class PrioritizeTool_Update_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler( IEnumerable<CodeInstruction> origCode )
        {
            ...
            if ( !patched )
                Debug.LogWarning( "[PriorityZero] Unable to find priority cursor offset." );
        }
    }
    ...
    public class PriorityScreen_InstantiateButtons_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler( IEnumerable<CodeInstruction> origCode )
        {
            ...
            if ( !patched )
                Debug.Log( "[PriorityZero] Error finding Priority Screen Buttons offset." );
        }
    }
    ...
    public class PriorityScreen_SetScreenPriority_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler( IEnumerable<CodeInstruction> origCode )
        {
            ...
            if ( !patched )
                Debug.LogWarning( "[PriorityZero] Unable to find set Priority Screen offset." );
        }
    }
}
