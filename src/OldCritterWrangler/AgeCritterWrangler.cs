...
namespace OldCritterWrangler
{
    internal class AgeCritterWrangler : KMonoBehaviour, IThresholdSwitch, ICheckboxControl, ISim4000ms
    {
                ...
                foreach (var creature in roomOfGameObject.cavity.creatures)
                {
                    ...
                    if (flag)
                    {
                        ...
                        if (ShouldMurder)
                        {
                            ...
                            if (FactionManager.Instance.GetDisposition(FactionManager.FactionID.Duplicant,
                                    faction.Alignment) != FactionManager.Disposition.Assist)
                        ...
                        else
                        {
                            ...
                            if (faction != null) faction.gameObject.Trigger(2127324410);
                        }
                    }
                    else
                    {
        ...
        public string AboveToolTip => "Wrangle creatures if they are above {0}% of the way through their life";
        public string BelowToolTip => "Wrangle creatures if they are below {0}% of the way through their life";
