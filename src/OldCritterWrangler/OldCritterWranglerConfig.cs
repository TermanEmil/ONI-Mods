...
namespace OldCritterWrangler
{
    class OldCritterWranglerConfig : IBuildingConfig
    {
        ...
        public static string Description = "A Wrangling Station can be used to designate critters to wrangle automatically.";
        public static string Effect = "Allows precise control over the age of critters kept in a room.";

        public override BuildingDef CreateBuildingDef()
        {
            var buildingDef = BuildingTemplates.CreateBuildingDef(Id, 1, 3,
                "relocator_dropoff_kanim", 10, 10f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.RAW_METALS, 1600f,
                BuildLocationRule.OnFloor, BUILDINGS.DECOR.PENALTY.TIER2, NOISE_POLLUTION.NOISY.TIER0);
