...
namespace ExpandedDuplicantMultitools
{
    ...
    {
        public static void Postfix() { Equipment.ExpandedAssignableSlots.LoadAllEquipment(); }
    }
    ...
    public static class ExtraSkills
    {
        ...
        public static void InitializeSkillsAndPerks()
        {
            ...
            NeutroniumDiggingPerk = skillPerks.Add(
                new SimpleSkillPerk(
            ...
            NeutroniumDigging.priorSkills = new List<string>() {skills.Mining3.Id};
            NeutroniumDigging.perks = new List<SkillPerk>() {NeutroniumDiggingPerk};
        }
    }
}
