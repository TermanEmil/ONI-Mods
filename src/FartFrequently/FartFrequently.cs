...
namespace FartFrequently
{
    ...
    internal class FartFrequently
    {
        ...
        {
            public static void Prefix( Flatulence __instance ) { SetValues(); }
            ...
            public static void SetValues()
            {
                ...
                harmony.Patch(
                    AccessTools.Method( typeof( Flatulence ), "Emit" ),
                    null,
                    null,
                ...
                Debug.Log(
                    ...
                    "Kg of " +
                    FlatulenceEmitTranspiler.EmitElement +
                    " at a " +
                    SplashMessageScreenOnPrefabInitPatches.Conf.Min +
                    "-" +
                    SplashMessageScreenOnPrefabInitPatches.Conf.Max +
                    " interval"
                );
            }
        }
        ...
        public class FlatulenceEmitTranspiler
        {
            ...
            public static IEnumerable<CodeInstruction> Transpiler( IEnumerable<CodeInstruction> instructions )
            {
                ...
                instList[90] = new CodeInstruction(
                    OpCodes.Ldsfld,
                    typeof( FlatulenceEmitTranspiler ).GetField( "EmitElement" )
                );

                instList[93] = new CodeInstruction(
                    OpCodes.Ldsfld,
            ...
            public void SetFromConfig()
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if ( !TryParse( Element, out SimHashes elementEnum ) )
