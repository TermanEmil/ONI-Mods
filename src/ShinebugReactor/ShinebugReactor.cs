...
namespace ShinebugReactor
{
    ...
    public class ShinebugReactor : Generator
    {
        private readonly Dictionary<string, ShinebugEggData> _shinebugEggValues =
            ...
            {
                {"LightBugBlackEgg", new ShinebugEggData {TimeToHatch = 9000f, AdultLife = 45000f, AdultLux = 0f}},
                {"LightBugBlueEgg", new ShinebugEggData {TimeToHatch = 3000f, AdultLife = 15000f, AdultLux = 1800f}},
                {
                    "LightBugEgg", new ShinebugEggData
                                   {
                                   #if DEBUG
                                       TimeToHatch = 15f,
                                       AdultLife = 45f,
                ...
                {"LightBugCrystalEgg", new ShinebugEggData {TimeToHatch = 9000f, AdultLife = 45000f, AdultLux = 1800f}},
                {"LightBugOrangeEgg", new ShinebugEggData {TimeToHatch = 3000f, AdultLife = 15000f, AdultLux = 1800}},
                {"LightBugPinkEgg", new ShinebugEggData {TimeToHatch = 3000f, AdultLife = 15000f, AdultLux = 1800f}},
                {"LightBugPurpleEgg", new ShinebugEggData {TimeToHatch = 3000f, AdultLife = 15000f, AdultLux = 1800f}}
            };
        ...
        private void OnStorageChanged( object data )
        {
            ...
            else
            {
                ...
                _shinebugEggs.Add(
                    new ShinebugEggSimulator( nameStr, values.TimeToHatch, values.AdultLife, values.AdultLux, go )
                );
            }
        }
        ...
        private void OnDeconstruct( object data )
        {
            ...
            foreach ( var shinebug in _shinebugs )
                GameUtil.KInstantiate(
                    Assets.GetPrefab( shinebug.Name.Replace( "Egg", "" ) ),
        ...
        public override void EnergySim200ms( float dt )
        {
            ...
            #endif
                _shinebugs.Add(
                    new ShinebugSimulator( egg.Name.Replace( "Egg", "" ), 0, egg.GrownLifeTime, egg.LuxToGive )
                );

                var eggShell = Util.KInstantiate(
                    Assets.GetPrefab( (Tag) "EggShell" ),
            ...
            foreach ( var shinebug in _shinebugs )
            {
                ...
                var eggItem = GameUtil.KInstantiate(
        ...
        private void UpdateStatusItem()
        {
            ...
            if ( _statusHandle == Guid.Empty )
                ...
                GetComponent<KSelectable>().ReplaceStatusItem(
                    _statusHandle,
                    ReactorStatusItem.ShinebugReactorWattageStatus,
                    this
                );
        }
    }
